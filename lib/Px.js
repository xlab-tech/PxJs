...
class Px {
  ...
  static branchIf(...pipes) {
    return Px.create().branchIf(...pipes);
  }
  ...
  static concatCurry(...pipes) {
    return Px.create().concatCurry(...pipes);
  }
  ...
  concatCurry(func) {
    return this._createSequenceDescription('concatCurry', func);
  }
